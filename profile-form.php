...
<div class="tml tml-profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="<?php $template->the_action_url( 'profile', 'login_post' ); ?>" method="post">
		...
		<tr class="tml-user-login-wrap">
			...
			style="width: 200px !important; min-width: 200px; max-width: 200px;" disabled="disabled" class="regular-text" /> <span class="description"><br><?php _e( 'Usernames cannot be changed.', 'theme-my-login' ); ?></span></td>
		</tr>
		...
		<tr class="tml-user-email-wrap">
			...
			style="width: 200px !important; min-width: 200px; max-width: 200px;" value="<?php echo esc_attr( $profileuser->user_email ); ?>" class="regular-text" /></td>
			<?php
		...
		<tr class="tml-user-url-wrap">
			...
			style="width: 200px !important; min-width: 200px; max-width: 200px;" 
			value="<?php echo esc_attr( $profileuser->user_url ); ?>" class="regular-text code" /></td>
		</tr>
			...
			<td>
				...
				<div class="wp-pwd hide-if-js">
					<span class="password-input-wrapper">
						...
						style="width: 200px !important; min-width: 200px; max-width: 200px;" 
						value="" autocomplete="off" data-pw="<?php echo esc_attr( wp_generate_password( 24 ) ); ?>" aria-describedby="pass-strength-result" />
					</span>
		...
		<tr class="user-pass2-wrap hide-if-js">
			...
			<td>
			<input name="pass2" type="password" id="pass2" class="regular-text" 
			style="width: 200px !important; min-width: 200px; max-width: 200px;" 
